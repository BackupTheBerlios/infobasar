# param_std.sql
# $Id: param_std.sql,v 1.4 2004/06/17 22:57:57 hamatoma Exp $
...
update infobasar_macro set value='<br>Der Seitenaufbau benötigte [RuntimeSecMicro] sec auf dem Server.' where Name = 'RuntimeSec';
/*
CSS-Datei
*/
